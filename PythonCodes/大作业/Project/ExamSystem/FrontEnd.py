...
class FrontEnd:
    ...
    def showInitFsm(self):
        ...
        self.count = 0
        print('[Function: Init_fsm] complicated') # 打印日志
    ...
    def checkAns(self) -> int:
        """ 检查结果，返回本题得分 """
        if self.state == STATE_SINGLE:  # 单选题分数判定
            ...
            if list2str(
                ...
                return 0
        elif self.state == STATE_MULTI:  # 多选题分数判定
            print('     [Debug: your choice:] ' + str(self.ans))
            if list2str(
